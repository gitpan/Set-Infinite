...
@horario_dia = $horario_mes[0]->quantize(unit=>'days', quant=>1) ;
...
test ('', ' join (" ", $a->quantize(unit=>"years", quant=>1) ) ', 
...
#print "Years: \n";
$a = Set::Infinite->new('1998-01-01', '2002-01-01');
test ('', ' join (" ", $a->quantize(unit=>"years") ) ',
...
test ('', ' join (" ", $a->quantize(unit=>"months") ) ',
...
test ('', ' join (" ", $a->quantize(unit=>"days") ) ',
...
test ('', ' join (" ", $a->quantize(unit=>"hours") ) ',
...
test ('', ' join (" ", $a->quantize(unit=>"minutes", quant=>15) ) ',
...
$a = Set::Infinite->new(
    ['21:35:45', '21:43:00'],
	['21:45:10', '21:47:15']);
test ('', ' join (" ", $a->quantize(unit=>"seconds", quant=>30) ) ',
